...
import com.steffi.traversal.SearchClientThread;
import com.steffi.traversal.actors.SearchActor;
...
public class SearchWorkerManager {
	...
	private void initManagerSockets() {
		String[] traversalManagerIPs = SteffiGraph.getInstance().getTraversalManagerIps();
